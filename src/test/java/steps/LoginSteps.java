...
// we get all this as an error when we run the Login.feature without writing the code for the steps
// this is how we're going to get steps each time
...
public class LoginSteps extends CommonMethods {
    ...
    public void user_enters_valid_admin_username_and_password() throws InterruptedException {
        ...
        sendText(login.usernameTextField, ConfigReader.getPropertyValues("username"));

        //  WebElement passwordTextField = driver.findElement(By.id("txtPassword"));
        //  passwordTextField.sendKeys("Hum@nhrm123");
        sendText(login.passwordTextField, ConfigReader.getPropertyValues("password"));
    }
